  ...
  <div class="header" :class="[{ fixedToTop, },themeColor]">
    <div class="logo">
      <a href="/">
        <svg v-show="themeColor==='is-transparent'" width="197" height="35">
          ...
          <g fill="none" fill-rule="evenodd">
            ...
            <g transform="translate(41.184 12.031)">
              ...
              <path fill="#FFF" mask="url(#logo-white_svg__f)" d="M70.24 3.06h8.544v-1.9h-8.545z" />
        ...
        <svg v-show="themeColor==='main-color'" width="197" height="35">
          <defs>
          ...
          <g fill="none" fill-rule="evenodd">
            ...
            <path
              ...
              fill="#3960AC"
            />
            <path fill="#79CBC6" d="M31.645 31.992l-5.429 1.394V5.764l5.429 1.394z" />
            <path fill="#4882C2" d="M8.608 32.689l5.428-1.394V19.521l-5.428-1.394z" />
